...
static_assert(std::is_same_v<
    decltype(std::declval<const hive_type&>().begin()),
    hive_type::const_iterator>);
static_assert(std::is_same_v<
    decltype(std::declval<const hive_type&>().end()),
    hive_type::const_iterator>);
static_assert(std::is_same_v<
    decltype(std::declval<const hive_type&>().cbegin()),
    hive_type::const_iterator>);
static_assert(std::is_same_v<
    decltype(std::declval<const hive_type&>().cend()),
    hive_type::const_iterator>);
static_assert(std::is_same_v<
    decltype(*std::declval<hive_type::const_iterator>()),
    const int&>);
static_assert(std::is_same_v<
    decltype(std::declval<hive_type::const_iterator>().operator->()),
    const int*>);
static_assert(std::is_constructible_v<
    hive_type::const_iterator, hive_type::iterator>);
static_assert(!std::is_constructible_v<
    hive_type::iterator, hive_type::const_iterator>);
